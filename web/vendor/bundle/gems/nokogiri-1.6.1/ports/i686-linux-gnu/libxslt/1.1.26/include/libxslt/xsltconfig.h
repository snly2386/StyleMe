...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/vagrant/StyleMe/StyleMe/web/vendor/bundle/gems/nokogiri-1.6.1/ports/i686-linux-gnu/libxslt/1.1.26/lib/libxslt-plugins"
#endif
